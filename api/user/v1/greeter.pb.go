...
const file_user_v1_greeter_proto_rawDesc = "" +
	"\n" +
	"\x15user/v1/greeter.proto\x12\rhelloworld.v1\x1a\x1cgoogle/api/annotations.proto\"\"\n" +
	...
	"\x1cdev.kratos.api.helloworld.v1B\x11HelloworldProtoV1P\x01Z\x1fmy-project/api/helloworld/v1;v1b\x06proto3"

var (
	file_user_v1_greeter_proto_rawDescOnce sync.Once
	file_user_v1_greeter_proto_rawDescData []byte
)

func file_user_v1_greeter_proto_rawDescGZIP() []byte {
	file_user_v1_greeter_proto_rawDescOnce.Do(func() {
		file_user_v1_greeter_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_user_v1_greeter_proto_rawDesc), len(file_user_v1_greeter_proto_rawDesc)))
	})
	return file_user_v1_greeter_proto_rawDescData
}

var file_user_v1_greeter_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_user_v1_greeter_proto_goTypes = []any{
...
func file_user_v1_greeter_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_user_v1_greeter_proto_rawDesc), len(file_user_v1_greeter_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
